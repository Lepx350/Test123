"""
Storyboard Visual Engine v10.7 — Web Edition
...
<div class="sub">v10.7 · {datetime.now().strftime('%Y-%m-%d %H:%M')} · {style_name} · {len(state["panels"])} panels · {img_count} images</div></div>'''
